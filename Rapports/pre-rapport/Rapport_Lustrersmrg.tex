...
\setlength\parindent{2.5pt} % Uncomment to remove all indentation from paragraphs
...
\textsc{\LARGE Universtité de Lorraine}\\[1.5cm] % Name of your university/college
\textsc{\Large Projet Tutoré}\\[0.5cm] % Major heading such as course name
\textsc{\large ASRALL}\\[0.5cm] % Minor heading such as course title

\HRule \\[0.4cm]
{ \huge \bfseries Systèmes de Fichiers Distribués}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\emph{Supervisor:} \\
 Stephane \textsc{CASSET} % Supervisor's Name
\end{flushright}
\end{minipage}\\[4cm]
